...
Then, open a Terminal window and clone this repo:
 ...
 ```
 git clone https://github.com/ucb-datalab/course_materials_spring2025.git
 ```
...
You may wish to work directly from your laptop. To do so:
 ...
 ```
 cd course_materials_spring2025
...
Periodically in the `course_materials_spring2025` directory. If you've edited a file that is due to be changed, this can cause conflicts. Doing a `git stash` before the `pull` should help. But to avoid this, consider making a copy of any repo file you'd like to edit.
